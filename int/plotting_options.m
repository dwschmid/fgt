...
switch lower(Action)
    case 'initialize'
        ...
        b_width                  = DefaultUicontrolPosition(3)+2;
        gap                      = 5;
        ...
        uicontrol('Parent', popts_upanel_curvature, 'style', 'text', 'String', '* Smoothing without small area (markers)','HorizontalAlignment', 'left', ...
        ...
        uicontrol('Parent', popts_upanel_curvature, 'style', 'text', 'String', '* Smoothing with small area (lines)','HorizontalAlignment', 'left', ...
